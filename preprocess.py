...
def _get_driver_id(driver_path: str) -> int: #driver number
        ...
        for driver in tqdm(driver_names):
            ...
            for state in state_names:
                ...
                for source in source_names:
                    ...
                    state_img_names_ = state_img_names_[start_idx: end_idx: step_between_frames] #select frames based on the given step interval and the trimming indices
                    ...
                    if generate_new:
                        os.makedirs(
                            #driver "tester1", state "drinking", source "Front_IR"
...
#step between frames takes the 2nd frame in each two frames, 
# start = 0.1 means that you will skip first 10% of the data, while end = 0.9 means you will skip the last 10% of the data.